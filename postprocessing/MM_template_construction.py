...
def main():
    ...
    parser.add_argument("--HR-reg-metrics", default="CC",help="Type of similarity metric used for pairwise registration (CC by default)")
    ...
    parser.add_argument('--res-HR', type=float, default=0.4, help="pixel resolution in mm (default: 0.4)")
