...
def main():
    parser = argparse.ArgumentParser(description="symmetrize template")
    ...
    parser.add_argument('--modalities', nargs='+', required=True,help="List of modalities/masks to symmetrise (e.g. label-WM_mask label-GM_mask label-CSF_mask desc-brain_mask)")
