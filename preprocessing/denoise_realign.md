...
```bash
python preprocessing/realign_subjects_2_Haiko89.py \
  --subjects_csv list_of_subjects/subjects_ses-3.csv --bids_root BaBa21_openneuro \
  --sym --generate_brainmask --flipping_LR \
  --input_folder derivatives/denoised --bids_description denoised --output_derivatives warped_den
```
